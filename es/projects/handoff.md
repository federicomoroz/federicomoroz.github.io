...
Las dos cifras que importan van publicadas por separado: **83% el sistema completo, 67% el modelo antes de las reglas.** La distancia entre las dos es lo que aportan las reglas, y una sola cifra combinada la escondería. De las 36 situaciones, tres fallan siempre y dos comparten el mismo error: el envío figura como perdido y el agente le pide al cliente una foto de un paquete que no existe. Es criterio, no cuentas, y ahí el límite es el tamaño del modelo — la pieza que lo reemplazaría es un parámetro.
